    ...
    'features' => [
        ...
        'speech_to_text' => [
            ...
            'vad' => [
                ...
                'engine' => env('AI_SPEECH_TO_TEXT_VAD_ENGINE', 'node'),
                ...
                'node_binary' => env('AI_SPEECH_TO_TEXT_VAD_NODE_BINARY', 'node'),
                'node_script' => env('AI_SPEECH_TO_TEXT_VAD_NODE_SCRIPT', 'scripts/vad.mjs'),
            ],
        ],
    ],
];
